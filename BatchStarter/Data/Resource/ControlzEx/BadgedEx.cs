...
namespace BatchStarter.Data.Resource.ControlzEx
{
    ...
    internal class BadgedEx : ContentControl
    {
        ...
        public static readonly DependencyProperty BadgeProperty = DependencyProperty.Register(
            "Badge", typeof(object), typeof(BadgedEx), new FrameworkPropertyMetadata(default, FrameworkPropertyMetadataOptions.AffectsArrange, OnBadgeChanged));
        ...
        private static void OnBadgeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            RoutedPropertyChangedEventArgs<object?>? args = new(e.OldValue, e.NewValue)
            { 
